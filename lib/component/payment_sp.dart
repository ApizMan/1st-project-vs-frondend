...
class PaymentspScreen extends StatefulWidget {
  final UserProfile userProfile;
  const PaymentspScreen({super.key, required this.userProfile});

  @override
  State<PaymentspScreen> createState() => _PaymentspScreenState();
}

class _PaymentspScreenState extends State<PaymentspScreen> {
  String _currentDate = '';
  String _currentTime = '';
  String? shortcutLink;
            ...
            children: [              
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 50),
                  Expanded(
                    child: Text( GlobalState.location,
                      style: GoogleFonts.firaCode(),
                      textAlign: TextAlign.right, // Align text to the right
                    ),
                  ),
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 50),
                  Expanded(
                    child: Text('${GlobalState.month} month',
                      style: GoogleFonts.firaCode(),
                      textAlign: TextAlign.right, // Align text to the right
                    ),
                  ),
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 50),
                  Expanded(
                    child: Text('RM ${GlobalState.amount}',
                      style: GoogleFonts.firaCode(
                        fontWeight: FontWeight.bold
                      ),
                      textAlign: TextAlign.right, // Align text to the right
              ...
              Center(
                child: Row(
                  ...
                  children: [
                    ...
                    Flexible(
                      child: Text(
                        'You will be bring to 3rd Party website for \nReload Token. Please ensure the detail above \nis accurate.',
                        style: GoogleFonts.firaCode(                    
                          color: Colors.red,
                          fontSize: 12,
                        ),
              ...
              Center(
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: (){ 
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => ReceiptScreen(userProfile: widget.userProfile),
                        ),
